          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <motion.div
                  key={index}
                  className="p-8 bg-white/5 backdrop-blur-sm border border-white/10 text-center"
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  whileHover={{ scale: 1.05, borderColor: 'rgba(255,115,195,0.5)' }}
                >
                  <div className="text-4xl md:text-5xl font-display font-black text-pink mb-2">
                    {stat.value}
                  </div>
            ...
            {team.map((member, index) => (
              ...
              >
                ...
                <div className="relative mx-auto w-32 h-32 mb-6">
                  <motion.div 
                    className="w-full h-full rounded-full bg-gradient-to-br from-pink to-purple-500 flex items-center justify-center"
                  ...
                  {/* Glow effect */}
                  <div className="absolute inset-0 rounded-full bg-pink/30 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
